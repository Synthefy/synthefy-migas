...
#
# Edit `bullish_predictive` / `bearish_predictive` below to craft your own
# counterfactual narratives and watch the forecast shift.
...
# splice_summary handles both str and list[str] (ensemble mode)
